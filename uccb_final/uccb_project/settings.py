...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-uccb-gestion-academique-2025')
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='Daron'),
        'USER': config('DB_USER', default='root'),
        'PASSWORD': config('DB_PASSWORD', default='Daron'),
